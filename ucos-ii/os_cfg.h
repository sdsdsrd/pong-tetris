...
#define OS_TASK_STAT_STK_SIZE   100u   /* Statistics task stack size (# of OS_STK wide entries)        */
#define OS_TASK_IDLE_STK_SIZE   100u   /* Idle       task stack size (# of OS_STK wide entries)        */
